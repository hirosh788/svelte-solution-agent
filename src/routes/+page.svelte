<div class="wrap_container">
    ...
    <div class="wrap_contents">
        <div class="wrap_search margin-10px-bottom">
            <em>SEARCH <i class="xi-search"></i></em>
            <div>
                <select class="select width-150px margin-5px-left custom-select">
        ...
        <div class="box_type_01" style="height: calc(100% - 46px);">
            <div class="padding-10px-lr padding-10px-top">
                <div>
                    ...
                    <div class="ps ps--active-y" style="max-height: calc(100vh - 310px);">
                        <table class="table_list_02">
                            <colgroup >
                                <col width="7.142857142857143%">
                                <col width="7.142857142857143%">
                    ...
                    <table class="table_list_02 margin-5px-top">
                        <colgroup >
                            <col width="7.142857142857143%">
                            <col width="7.142857142857143%">
                            <col width="7.142857142857143%">
